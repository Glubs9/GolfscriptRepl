...
#code=gets(nil)||''
#this is commented out so that the code doesn't need to be fed a file
...
#######################################################################################
#repl starts here
# add support for arrow keys to switch through commands enterered
# although this might end up needing something like curses which is more effort then i'm putting
# into this

code = "'welcome to Jontes golfscript repl'p;"
